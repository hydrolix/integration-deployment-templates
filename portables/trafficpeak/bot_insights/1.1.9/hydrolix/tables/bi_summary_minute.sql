-- Summary: Bot Insights Summary Minute
-- Derived from deployed `bi_summary_minute` schema
-- Granularity: 1 minute
-- Parent table: bot_detection (via __TABLE_NAME__ placeholder)
-- Dimensions retained: timestamp, request_host, hdx_cdn, bot_class, ai_category, is_bot_traffic, client_asn, asn_type, resource_category, request_method
