...
The exported `resources.gfo.yaml` folder hierarchy is derived automatically from `data_category` in `bundle-config.json`. No additional fields are required.

| `data_category` | Dashboard folder in Grafana |
|---|---|
